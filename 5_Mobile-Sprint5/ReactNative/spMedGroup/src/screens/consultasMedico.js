...
export default class ConsultasMed extends Component {
    constructor(props) {
        super(props);
        this.state = {
            listaConsultas: []
    ...
    buscarConsultas = async () => {
        ...
        const resposta = await api.get('/Consultas/minhas/medico', {
            headers: {
            ...
            <View style={styles.main}>
                <View style={styles.header}>
                    <View style={styles.headerTitulo}>
                        <Text style={styles.titulo1}>{'Cons'.toUpperCase()}</Text> 
                        <Text style={styles.titulo2}>{'ultas'.toUpperCase()}</Text>  
                    </View>
